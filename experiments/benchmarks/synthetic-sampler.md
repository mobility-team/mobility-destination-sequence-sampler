...
the `research-archive-2026-07-29` Git tag. Its useful lesson was to reuse prepared indexes
...
```powershell
git show research-archive-2026-07-29:experiments/benchmarks/perf_synthetic_case.py
```
