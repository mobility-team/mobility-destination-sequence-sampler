# Archived hierarchical-kernel result

Far-field OD structure was compressible (about 6.1x storage reduction in the
tested configuration), but local travel structure and missing OD pairs made a
